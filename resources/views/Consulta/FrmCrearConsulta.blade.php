...
{{-- <div id="idhistoria"></div> RECIBIA EL ID_HISTORIA PARA COMPROBAR --}}
	...
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-body">
					...
					<div class="form-group">
				    	<div class="input-group input-group-sm" style="margin-bottom: -10px;">
							...
							{!! Form::text('fecha_inicio',$fecha,['id'=>'fecha_inicio','class'=>'form-control','placeholder'=>'Fecha']) !!}
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group input-group-sm" style="margin-bottom: -10px; margin-top: -10px;">
							...
							{!! Form::text('hora_inicio',$hora,['id'=>'hora_inicio','class'=>'form-control','placeholder'=>'hora']) !!}
						</div>
					</div>
					...
					<div class="form-group">
				    	<div class="input-group input-group-sm" style="margin-bottom: -10px; margin-top: -10px;">
							...
							{!! Form::text('historia',null,['id'=>'historia','class'=>'form-control','placeholder'=>'Historia de la enfermedad actual']) !!}
						</div>
					</div>				    
					...
					<div class="form-group">
						{!! Form::hidden('id_consulta','',['id'=>'id_consulta','class'=>'form-control','placeholder'=>'idc']) !!}
					</div>
						...
						<div class="container" id="EFS" style="margin-top: 15px; margin-left: -17px; margin-right: -30px;">
							...
							<div class="form-group">
						    	<div class="input-group input-group-sm" style="margin-bottom: -10px; margin-top: -10px;">
									...
									{!! Form::text('otros',null,['id'=>'otros','class'=>'form-control','placeholder'=>'Otros']) !!}
								</div>
							</div>
		...
		<div class="panel panel-default disabledTab" id="Tab7">
...
$('#ocultarP').click(function(){
	...
	$('#guardarE').on('click',function(e){
		...
		var url = "{{ route('evaluacion.store') }}";
